...
public class MtlsResttemplateApplication {
	...
	public class Controller {
		...
		public String get(HttpServletRequest httpServletRequest) {
			...
			return restTemplate.getForObject("https://mtls-mvc-example/b/get", String.class);
		}

		@GetMapping("/a/getC")
		public String getD(HttpServletRequest httpServletRequest) {
			X509Certificate[] certs = (X509Certificate[]) httpServletRequest.getAttribute("javax.servlet.request.X509Certificate");
			return restTemplate.getForObject("https://mtls-webflux-example/c/get", String.class);
		}
